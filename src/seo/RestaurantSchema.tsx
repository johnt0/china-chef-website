export default function RestaurantSchema() {
    const data = {
        ...
        description:
            'Family-owned Chinese American takeout in Nottingham, MD. Lunch special Mon–Sat, all-day special platter, and a full menu of classic and Szechuan dishes. Open 7 days.',
